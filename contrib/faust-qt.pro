...
RESOURCES += src/qt/faust.qrc src/qt/faust_locale.qrc

TRANSLATIONS += src/qt/locale/faust_bg.ts \
                src/qt/locale/faust_de.ts \
                src/qt/locale/faust_en.ts \
                src/qt/locale/faust_es.ts \
                src/qt/locale/faust_fi.ts \
                src/qt/locale/faust_fr.ts \
                src/qt/locale/faust_it.ts \
                src/qt/locale/faust_ja.ts \
                src/qt/locale/faust_pl.ts \
                src/qt/locale/faust_pt.ts \
                src/qt/locale/faust_ru.ts \
                src/qt/locale/faust_sk.ts \
                src/qt/locale/faust_sv.ts \
                src/qt/locale/faust_vi.ts \
                src/qt/locale/faust_zh_CN.ts \
                src/qt/locale/faust_zh_TW.ts
