/* src/config/faust-config.h.  Generated from faust-config.h.in by configure.  */
/* src/config/faust-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://faust.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Faust Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Faust Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "faust"
