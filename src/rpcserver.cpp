...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FAU features */
        {"faust", "masternode", &masternode, true, true, false},
        {"faust", "masternodelist", &masternodelist, true, true, false},
        {"faust", "mnbudget", &mnbudget, true, true, false},
        {"faust", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"faust", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"faust", "mnsync", &mnsync, true, true, false},
        {"faust", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"faust", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use faustd, or the -server option to faust-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Faust Alert\" admin@foo.com\n"),
...
{
    return "> faust-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28988/\n";
}
