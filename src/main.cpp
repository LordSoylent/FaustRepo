...
#if defined(NDEBUG)
#error "Faust cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Faust Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 4200 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 4200 && nHeight <= 10200 ) {
	        nSubsidy = 52 * COIN;
	}else if( nHeight > 10200 && nHeight <= 27200 ) {
	        nSubsidy = 105 * COIN;
	}else if( nHeight > 27200 && nHeight <= 55200 ) {
	        nSubsidy = 64 * COIN;
	} else {
		nSubsidy = 31 * COIN;
	}
