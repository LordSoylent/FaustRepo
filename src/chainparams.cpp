...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000d4ffd7b42748f70e1bca58e64cb121c13d6c7f02261aae4d89fd1943cbb"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1530289247, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Faust Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530289247;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22130828;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000d4ffd7b42748f70e1bca58e64cb121c13d6c7f02261aae4d89fd1943cbb"));
        assert(genesis.hashMerkleRoot == uint256("0x17f7d4125689a47c4797419d9d001c0b4b5329be20cd8492188e315562e3732e"));
        

        vSeeds.push_back(CDNSSeedData("seed1.faust.cash", "seed1.faust.cash"));
        vSeeds.push_back(CDNSSeedData("seed2.faust.cash", "seed2.faust.cash"));
        vSeeds.push_back(CDNSSeedData("seed3.faust.cash", "seed3.faust.cash"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1530289247; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1530289248;
        genesis.nNonce = 20669975;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000029fe058c089a3a4ef684d34e48978c2c47fe024b5cec08785c775e717a9"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Faust BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Faust BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Faust BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1530289248;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1530289249;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x7d948976ffca8720671e47ba7d3fbef7c8541c97986d750ac602d902958052e3"));
